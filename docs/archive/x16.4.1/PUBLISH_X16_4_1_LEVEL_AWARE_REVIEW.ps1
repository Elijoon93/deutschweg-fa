...
$backupBranch = "backup/x16.4.0-before-level-aware-$stamp"
Invoke-Git branch $backupBranch
Invoke-Git push origin $backupBranch

$excluded = @(
    "PUBLISH_X16_4_1_LEVEL_AWARE_REVIEW.ps1",
    "DeutschWeg_X16_4_1_Level_Aware_Sponsor_26s_GitHub_Pages_Root.zip"
)
...
if (Get-Command node -ErrorAction SilentlyContinue) {
    ...
    Write-Warning "Node.js was not found. GitHub Actions will verify the payload after push."
}
...
Invoke-Git commit -m "fix(path): start learning plan at selected CEFR level and set sponsor gate to 26s"
Invoke-Git push origin main

Write-Host "Published successfully."
Write-Host "Backup branch: $backupBranch"
Write-Host "Next: complete FINAL_ACCEPTANCE_X16_4_2.md on real Android and iPhone devices."
